...
function PLUGIN:SetNextInterval(indentifier, int)
	self.timer[indentifier][3] = SysTime()+int
end

function PLUGIN:AdjustInterval(indentifier, newInt)
	self.timer[indentifier][2] = newInt
	self.timer[indentifier][3] = SysTime()+newInt
end
