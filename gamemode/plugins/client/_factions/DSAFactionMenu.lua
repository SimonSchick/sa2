include("DSAFactionList.lua")
include("DSAFactionInformation.lua")
surface.CreateFont(
	"SAFactionMenuTitle",
	{
		font = "neuropol",
...
function PANEL:Init()
	...
	self._title:SetText("Faction menu")
	...
	self._tabHolder = vgui.Create("DPropertySheet", self)
	
	self._tabHolder.Paint = function() return true end
	
	self._factionListing = vgui.Create("DSAFactionList", self)
	self._tabHolder:AddSheet("Factions", self._factionListing, "", false, false, "Information about the factions")
	
	self._factionInformation = vgui.Create("DSAFactionInformation", self)
	self._tabHolder:AddSheet(
		"My Faction",
		self._factionInformation,
		"",
		false,
		false,
		"Useful infos about your faction"
	)
end
...
function PANEL:PerformLayout(w, h)
	...
	self._tabHolder:StretchToParent(2, cSize+1, 2, cSize+1)
...
function PANEL:Update()
	self._factionInformation:Update()
	self._factionListing:Update()
end
...
vgui.Register("DSAFactionMenu", PANEL, "EditablePanel")